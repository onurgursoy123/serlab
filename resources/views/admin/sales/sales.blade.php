...
<style>
    ...
    <div class="container px-5 py-3">
        ...
        <div class="row justify-content-center mt-4">
            ...
            <form action="{{ route('admin.sales.mailAddress') }}" method="POST">
                @csrf
                @method('PUT')
                <div class="input-group mb-3">
                    <input type="email" class="form-control" value="{{ $data->description }}" name="mail" placeholder="Mail Adresi" aria-label="Mail Adresi" aria-describedby="button-addon2">
            ...
            <div class="col-12 m-3">
                ...
                <article>
                    ...
                    <div class="form-floating mb-3 border border-0">
                        <input type="number" class="form-control border border-0 border-bottom" id="floatingInput" placeholder="name@example.com" style="background-color: white; border-radius:0%">
                        <label for="floatingInput" style="color: rgb(108, 117, 125)">Telefon</label>
                    </div>
                    <div class="form-floating mb-3 border border-0">
                        <input type="mail" class="form-control border border-0 border-bottom" id="floatingInput" placeholder="name@example.com" style="background-color: white; border-radius:0%">
                    ...
                    <div class="form-floating mb-3 border border-0">
                        <div class="mb-3">
                            <label for="formFileMultiple" class="form-label ms-2"  style="color: rgb(108, 117, 125)">Cihaz Resimleri</label>
