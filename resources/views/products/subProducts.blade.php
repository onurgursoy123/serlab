    ...
    <div class="team-grid">
      <div class="container text-center">
        ...
        <div class="row people d-flex justify-content-center">
          ...
          <form id="searchForm" action="{{ route('products.subProducts.search', [$parent_id]) }}" style="visibility: hidden;" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            @foreach ($products as $product)
              ...
              @if (!empty($product) && !empty($product->img_json))
                ...
                <div class="col-lg-3 col-md-5 col-sm-6 col-9 item text-center p-1 m-0">
                  ...
                  <a href="{{ route('products.productList.index', [$product->id]) }}" class="text-decoration-none text-dark">
                    <div class="box border border-1 p-2">
                      <img src="{{ $url[0] }}" class="card-img-top" style="height: 200px;" alt="...">
                      <div class="card-body justify-content-center">
                        <div class="card-body">
                          <h6 class="card-title text-center pt-2">{{ $product->title }}</h6>
                        </div>
                      </div>
                      <div class="cover">
