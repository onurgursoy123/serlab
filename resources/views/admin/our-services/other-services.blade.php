  ...
  <div class="row mt-3">
    ...
    <div class="row d-flex justify-content-center">
      <div class="col-8 mt-2">
        ...
        <form id="guaranteeImageUpdate" class="text-center" action="{{ route('admin.our-services.otherServices.update') }}" method="POST" enctype="multipart/form-data">
          @csrf
          @method('put')
    ...
    <div class="row d-flex justify-content-center mt-3">
      <div class="col-8 text-end">
        ...
        <form id="guaranteeContentsUpdate" class="d-inline" action="{{ route('admin.our-services.otherServices.update') }}" method="POST">
          @csrf
          @method('put')
