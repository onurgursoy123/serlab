    ...
    <div class="team-grid">
      <div class="container text-center">
        ...
        <div class="row people d-flex justify-content-center">
          ...
          <form id="searchForm" action="{{ route('admin.products.subProducts.search', [$parent_id]) }}" style="visibility: hidden;" method="POST" enctype="multipart/form-data">
            @csrf
          ...
          <div class="col-lg-3 col-md-5 col-sm-6 col-9 item text-center p-1 m-0 border border-1">
            <div class="d-flex flex-column h-100 justify-content-center align-items-center">
              <span class="fw-bold">Yeni Alt Ketegori Ekle</span>

              <!-- Add product button -->
              <i data-bs-toggle="modal" data-bs-target="#subProductsAdd" class="bi bi-plus-square-fill fa-2x text-dark me-3"></i>

              <!-- Add product modal -->
              <div class="modal fade" id="subProductsAdd" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">

                    <!-- Modal Header -->
                    <div class="modal-header">
                      <h4 class="modal-title">Yeni Alt Kategori Ekle</h4>
                      <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>

                    <form id="dashboardProductsSuccess" action="{{ route('admin.products.subProducts.save') }}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <!-- Modal body -->
            ...
            @foreach ($products as $product)
              ...
              @if (!empty($product) && !empty($product->img_json))
                ...
                <div class="col-lg-3 col-md-5 col-sm-6 col-9 item text-center p-1 m-0">
                  ...
                  <a href="{{ route('admin.products.productList.index', [$product->id]) }}" class="text-decoration-none text-dark">
                    <div class="box border border-1 p-2">
                      <img src="{{ $url[0] }}" class="card-img-top" style="height: 200px;" alt="...">
                  ...
                  <div class="modal fade" id="productEdit{{ $product->id }}" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <form id="productEditForm" action="{{ route('admin.products.subProducts.update', [$product->id]) }}" method="POST" enctype="multipart/form-data">
                          @csrf
                          @method('put')
                          <!-- Modal body -->
                          <div class="modal-body">
