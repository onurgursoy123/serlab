...
<div class="container pt-0">
                    ...
                    <div class="row p-5 d-flex justify-content-center">
                      ...
                      @foreach ($file_url as $index => $file)
                        ...
                        <a href="{{ $file }}" target="_blank" class="card-link" style="text-decoration: none;">
                          <button type="button" class="list-group-item border border-0 border-bottom list-group-item-action">
                            ÜRÜN KATALOĞU - {{ $index + 1 }}<i class="bi bi-cloud-arrow-down d-flex justify-content-end"></i>
                          </button>
                        </a>
              ...
              <div class="card-body">
                  ...
                  @if (isset($product->priceLink) && !empty($product->priceLink))
                    <div class="card-body">
                      ...
                      <a href="{{ $product->priceLink }}" target="_blank" class="card-link" style="text-decoration: none; color:white;"><button type="button" class="btn btn-primary" style="color:white; width: 100%; height: 40px;">Satın Al</button></a>
                    </div>
                  @else
                    <div class="card-body">
                      <a href="{{ route('form.index') }}" class="card-link" style="text-decoration: none; color:white;"><button type="button" class="btn btn-primary" style="color:white; width: 100%; height: 40px;">Teklif İste</button></a>
                    </div>
                  @endif                  
              </div>
          </div>
  ...
  <div class="row">
            ...
            <div class="row mt-5 pt-5 text-center d-flex justify-content-center">
