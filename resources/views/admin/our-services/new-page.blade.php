    ...
    <div class="row mt-3">
      <div class="row d-flex justify-content-center mt-3">
        <div class="col-8 text-end">
            ...
            <form id="guaranteeContentsStore" class="d-inline" action="{{ route('admin.our-services.getDynamicUrl.store') }}" method="POST">
                @csrf

                <div class="input-group mb-3">
                    <span class="input-group-text" id="basic-addon3">Sayfanın Adı</span>
                    <input type="text" name="title" class="form-control" maxlength="35" id="basic-url" aria-describedby="basic-addon3" required>
                </div>
                  
                <div id="toolbar-container"></div>
                <div id="editor" style="height: 500px; border: 1px solid;"></div>
